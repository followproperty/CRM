...
export default function CallerLeadsTable({ leads }: CallerLeadsTableProps) {
  ...
  return (
    <div className="space-y-4">
                    ...
                    <tr key={leadId} className="hover:bg-slate-50/50 transition-colors">
                      ...
                      <td className="px-6 py-4 text-right">
                        {savingLeadIds.includes(leadId) ? (
                          <div className="flex justify-end items-center gap-1.5 text-xs font-semibold text-indigo-605">
      ...
      {activeOutcomeLead && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-600/40 backdrop-blur-xs animate-fade-in" onClick={(e) => e.target === e.currentTarget && !selectedSubStatus && closeOutcomeModal()}>
